...
```
#### AI Disclosure
With the newer age of development, development with the help of an LLM has gotten more and more popular. 
Student _does_ have some code that has been generated by AI for **some** complex functions or tedious tasks (for example most of the Hypothetical Mode code since Synergy has a very inconsistent typing for grade books), Student is not entirely "vibe coded" or made without oversight. **However**, all AI generated code is reviewed and I make sure I am _understanding_ the work an AI is outputting.

This will most likely be the future of how development works. Agents writing _some_ complex or tedious code with review and understanding by the human prompting it. Student is still reviewed and held up to high code standards for security.
